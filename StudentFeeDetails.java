...
public class StudentFeeDetails extends JFrame implements ActionListener {
    ...
    StudentFeeDetails(){
        ...
        heading = new JLabel("Show Student Fee Details!");
        ...
        try{
            ...
            ResultSet rs1 = JDBC.jdbcgetConnection().prepareStatement("select * from studentFee").executeQuery();
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Fiend){
            try{
                ResultSet rs = JDBC.jdbcgetConnection().prepareStatement("select * from studentFee where roll = '"+Search.getSelectedItem()+"'").executeQuery();
