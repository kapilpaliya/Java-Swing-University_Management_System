...
public class NewFaculty extends JFrame implements ActionListener {
    ...
    NewFaculty(){
        ...
        heading = new JLabel("Add New Faculty Details!");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Submit){
            String query = "insert into faculty values('"+Name.getText()+"',  '"+FatherName.getText()+"',  " +
                    "'"+EmployeeId.getText()+"',  " +
    ...
    public String getRandom(){
        ...
        try{
            ResultSet rs = JDBC.jdbcgetConnection().prepareStatement("select id from faculty where id = '"+s+"'").executeQuery();
            if(rs.next()){
                ok = getRandom();
            }
            else{
