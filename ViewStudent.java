...
public class ViewStudent extends JFrame implements ActionListener {
    ...
    ViewStudent(){
        ...
        heading = new JLabel("Show Student Details!");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Fiend){
            try{
                ResultSet rs = JDBC.jdbcgetConnection().prepareStatement("select * from student where roll = '"+Search.getSelectedItem()+"'").executeQuery();
