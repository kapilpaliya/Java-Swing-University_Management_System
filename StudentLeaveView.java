...
public class StudentLeaveView extends JFrame implements ActionListener {
    ...
    StudentLeaveView(){
        ...
        heading = new JLabel("Show Student Leave Details!");
        heading.setFont(new Font("Arial",Font.BOLD,25));
        heading.setBounds(235,10,350,30);
        ...
        try{
            ...
            ResultSet rs1 = JDBC.jdbcgetConnection().prepareStatement("select * from studentLeave").executeQuery();
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Fiend){
            try{
                ResultSet rs = JDBC.jdbcgetConnection().prepareStatement("select * from studentLeave where roll = '"+Search.getSelectedItem()+"'").executeQuery();
