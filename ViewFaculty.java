...
public class ViewFaculty extends JFrame implements ActionListener {
    ...
    JLabel heading, search; JButton Fiend, Print, Add, Update, Cancel;
    ...
    ViewFaculty(){
        ...
        heading = new JLabel("Show Faculty Details!");
        ...
        Search.setBounds(220,50,200,30);
        Search.setBackground(Color.white);
        Search.setFont(font);
        add(Search);
        ...
        Update.setBounds(320,100,120,30);
        ...
        try{
            ...
            ResultSet rs1 = JDBC.jdbcgetConnection().prepareStatement("select * from faculty").executeQuery();
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==Fiend){
            try{
                ResultSet rs = JDBC.jdbcgetConnection().prepareStatement("select * from faculty where id = '"+Search.getSelectedItem()+"'").executeQuery();
